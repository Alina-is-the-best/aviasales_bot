...
- Найти билеты: выбираем тип маршрута(простой, без пересадок, или сложный, с пересадками), тип билета(в одну сторону или туда и обратно), отвечаем на все доп вопросы по типу багажа и количеству пересадок и выбираем дату.
- Мои билеты: можно посмотреть отслеживаемые билеты.
- Настройки: 
    - Валюта: возможность выбрать валюту для билетов.
    - Постоянные фильтры: возможность выбрать постоянные место вылета, условия перевоза багажа, пересадки.
